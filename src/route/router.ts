...
router.get('/user/getUserCurrentOTP', getUserCurrentOTPController) // 获取用户当前的验证码
// https://localhost:9999/user/getUserCurrentOTP
// cookie: uuid, token

...
export const getConversationListController = async (ctx: koaCtx, next: koaNext) => {
	...
	const conversationFilterStr = ctx.query.conversationFilter as string | undefined
	...
	const getConversationListRequest: GetConversationListRequestDto = {
		...
		...(conversationFilterStr ? {
			conversationFilter: conversationFilterStr as GetConversationListRequestDto['conversationFilter'],
		} : {}),
	}
